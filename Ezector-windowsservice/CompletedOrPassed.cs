...
namespace Ezector_windowsservice
{
    public class CompletedOrPassed
    {
        ...
        {
            string logfilepath = Config.LogFile.ToString();
            ...
            try
            {
                ...
                SqlConnection con = new SqlConnection(Config.MainConnectionString);
                ...
                "and Convert(date,DateCompleted)=Convert(date,'" + DateTime.UtcNow.AddHours(Convert.ToDouble(Config.UTCHourAdjust)).AddDays(-1) + "')" +
                ...
                "and Convert(date,StudentActivity.CompletionDate)=Convert(date,'" + DateTime.UtcNow.AddHours(Convert.ToDouble(Config.UTCHourAdjust)).AddDays(-1) + "')" +
                ...
                //Writing user data into the file
                //************************
                string filepath = Config.FilePath.ToString();
               ...
               //Writing Log File    
                ...
                System.IO.File.AppendAllText(logfilepath, "\n" + DateTime.UtcNow.ToString() + " : Successfully Processed;" + Environment.NewLine);
            ...
            {
                //Writing Error in Log File
                System.IO.File.AppendAllText(logfilepath, "\n" + DateTime.UtcNow.ToString() + " : " + ex.Message.ToString() + Environment.NewLine);
